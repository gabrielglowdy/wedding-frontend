      ...
      >
        <div v-if="guest">
          <h2 class="inset-x-0 text-lg font-lora text-white text-center">
            Izinkan kami mengundang Anda dalam
          </h2>
          <h2 class="inset-x-0 font-normal text-5xl font-moon-dance text-white text-center">
            Acara Syukuran
          </h2>
        </div>
        <div v-else>
        ...
        <div v-if="guest" class="flex flex-col items-center mt-6">
          ...
          <a
            ...
            class="
              ...
              hover:bg-primary-terracotta/80
              cursor-pointer
              duration-1000
              shadow-buzz-green
              hover:duration-300
              border-2 border-primary-terracotta/50
              backdrop-blur-lg
              drop-shadow-lg
              py-3
              px-5
            ...
            <div class="flex items-center justify-center gap-2">
              <div v-for="(item, index) in musicCategories" :key="index">
                <div
                  ...
                  :class="{
                    'bg-primary-terracotta': index == selectedMusic,
