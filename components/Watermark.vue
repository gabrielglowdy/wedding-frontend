  ...
  <div>
    <div class="bg-white min-h-[50vh] md:min-h-[24vh] flex flex-col gap-3 justify-center px-4 items-center">
      ...
      <div class="flex flex-col items-center justify-center">
        <h6 :class="`text-xl md:text-2xl ${ color === 'terracotta' ? 'text-primary-terracotta' : 'text-primary'} italic font-lora`">
          Lilla dan Gabriel
        </h6>
        <h6 :class="`text-sm ${ color === 'terracotta' ? 'text-primary-terracotta' : 'text-primary'} italic font-lora`">
